...
\begin{itemize}
	...
	\item Investigate the Picasso problem (\textbf{THIS}), as this should actually be solved by CapsNets.
\end{itemize}
...
\subsection{The Squashing of Capsules results in a vanishing gradient}
\textbf{Open questions}
\begin{itemize}
...
\subsection{Issues regarding the Softmax}
%TODO: Unify section with Routing section, as the arguments overlap
\begin{itemize}
	...
	\item Furthermore we might get a really bad SNR for a larger number of Capsules.
