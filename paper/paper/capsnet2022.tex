...
Picasso Problem in CNNs. Does it even exist?
\url{https://www.sciencedirect.com/science/article/abs/pii/S0141938222000439}
Obvious reasons, hypothesized reasons or hopes, relying on the assumption that such a sematic concept would emerge.
\begin{itemize}
...
\begin{itemize}
	...
	\item A single layer of CapsNet does not yield a parse tree.
