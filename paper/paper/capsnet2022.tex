...
Components
\begin{itemize}
	\item Capsule: dedicated parts or objects, vector / matrix
	\item Backbone: Feature extraction, CNN,  receptive field requirement!
	\item Routing Algorithm, softmax and coupling
...
\begin{itemize}
	\item Sparse but strong activation of the Capsules [we can measure this]
	\item Strong but dynamic routing coefficients / coupling coefficients. [we can measure this]. Strong can be steered by agreement and softmax. Dynamic is more a hypothetical property.
