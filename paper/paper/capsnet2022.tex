...
a lack of robustness to affine transform%TODO add references%ations and novel viewpoints on the input data, 
the susceptibility to adversarial attacks,
exponential inefficiencies
and general lack of interpretability in the networks decision making process. %TODO: add references%
...
Furthermore, many CapsNet approaches don't report on ImageNet, but prefer to benchmark themselves on much smaller datasets like MNIST, SmallSNORB or CIFAR-10. %TODO add references%
...
Some follow-ups stick more or less closely %TODO add references%
Other works kind of throw things over and do stuff that is quite different. %TODO add references%
