...
class MultiMNist(Dataset):
    ...
    def __load_meta__(self):
        ...
        file1 = open(self.p_data / 'idx_1.plk', 'rb')
        id_1 = pickle.load(file1)
        file1.close()

        file2 = open(self.p_data / 'idx_2.plk', 'rb')
        id_2 = pickle.load(file2)
        file2.close()  

        file3 = open(self.p_data / 'padding_1.plk', 'rb')
        padding_1 = pickle.load(file3)
        file3.close()

        file4 = open(self.p_data / 'padding_2.plk', 'rb')
    ...
    def __multimatch__(self, p_data, data, n=1000):
        ...
        # proof path
        mkdir_directories([p_data], parents=True, exist_ok=True)
        ...
        file1 = open(p_data /'idx_1.plk', 'wb')
        pickle.dump(all_ref, file1)
        file1.close()

        #create target 2
        file2 = open(p_data /'idx_2.plk', 'wb')
        ...
        #create padding 1 
        file3 = open(p_data /'padding_1.plk', 'wb')
        pickle.dump(padding1, file3)
        file3.close()

        #create padding 2 
        file4 = open(p_data /'padding_2.plk', 'wb')
