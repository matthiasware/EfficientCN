...
if __name__ == '__main__':
    ...
    config2.train.transform = transform_train
    config2.vakid.transform = transform_valid
    ...
    config3.train.transform = transform_train
    config3.vakid.transform = transform_valid


    config4 = config.copy()
    config4.stop_acc = 1.1
